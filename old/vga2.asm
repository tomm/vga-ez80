...
scanout_line_with_pixeldata:
	...
	ld bc,152		; 4 cycles
	otirx			; 2 (+ 3*152 accounted for in next section)

	; 468 cycles (pixel data)  -> +0.73 spare
	;  - 456 cycles from otirx scanout
...
pixeldata:
	...
	db 155, 156, 157, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167
	db 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180
	db 181, 182, 183, 184, 185, 186, 187, 188, 189, 190, 191, 192, 193
	db 194, 195, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206
	db 207, 208, 209, 210, 211, 212, 213, 214, 215, 216, 217, 218, 219
	db 220, 221, 222, 223, 224, 225, 226, 227, 228, 229, 230, 231, 232
	db 233, 234, 235, 236, 237, 238, 239, 240, 241, 242, 243, 244, 245
